<?php
$Equipment_id=$_GET['CarRegistrationNo'];
$con = mysqli_connect('localhost','root','','db_car_bj');
$sql="SELECT * FROM tb_car WHERE CarRegistrationNo=$Equipment_id";
$result=mysqli_query($con, $sql);
$equipment_information=mysqli_fetch_assoc($result);

if(isset($_POST['ModelNo'])){
$Equipment_Name=$_POST['ModelNo'];
$Quantity=$_POST['EngineNo'];
$Availability=$_POST['OwnerShipHire'];

$sql="UPDATE tb_car SET ModelNo='$Equipment_Name',EngineNo='$Quantity',OwnerShipHire='$Availability' WHERE CarRegistrationNo=$Equipment_id";
mysqli_query($con, $sql);
header('Location:car_list.php?CarRegistrationNo='.$Equipment_id);
}
?>
<!doctype html>
<html lang="en">
