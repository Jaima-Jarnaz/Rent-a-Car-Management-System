...
<a href="car_add.php" class="button">Add Car</a>
</div>
</div>
...
if ($result->num_rows > 0) {
    ...
    echo"<tr><th colspan='7'><h1>Car record</h1></th></tr>";
    echo"<tr>";
    echo"<td><h2>Car Registration No</h2></td>";
    echo "<td><h2>Model No</h2></td>";
    echo "<td><h2>Engine No</h2></td>";
    echo "<td><h2>Hire/Own</h2></td>";
    ...
    <td><a href =delete_car.php?CarRegistrationNo=".$row["CarRegistrationNo"].">Delete</a>     </td>
    <td><a href =edit_car.php?CarRegistrationNo=".$row["CarRegistrationNo"].">Update</a>     </td>
    <td><a href =print_car.php?CarRegistrationNo=".$row["CarRegistrationNo"].">Print</a> </td>
    </tr>";
     }
     echo "</table>";
} else {
