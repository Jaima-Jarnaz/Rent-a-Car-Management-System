...
<head>
 ...
 <link rel="stylesheet" type="text/css" href="css/dashboard.css">
   <script src="https://kit.fontawesome.com/3b71e37289.js"></script>
	<title>Local Trip List Information</title>
</head>
<body>
<div class="wrapper">
	<!-- Sidebar/menu -->
...
<a href="localtripentry.php" class="button">Create Local Trip</a>
</div>
</div>
...
if ($result->num_rows > 0) {
    ...
    echo"<tr><th colspan='11'><h1>Local Trip Info</h1></th></tr>";
    echo"<tr>";
    ...
    <td>"  . $row["EndPoint"]."  </td>
    <td><a href =delete_local_trip.php?CarRegistrationNo=".$row["CarRegistrationNo"].">Delete</a>     </td>
    <td><a href =edit_local_trip.php?CarRegistrationNo=".$row["CarRegistrationNo"].">Update</a>     </td>
    <td><a href =print_local_trip.php?CarRegistrationNo=".$row["CarRegistrationNo"].">Print</a> </td>
    </tr>";
     }
     echo "</table>";
} else {
