...
if ($result->num_rows > 0) {
  echo"<table style='width:1043px; margin:auto; color:#314954; padding:5px; font-size:11px; border-color:darkgrey;border: currentColor;background-color: #d8dbe845;' border='5'>";
    ...
    echo"<tr>";
    echo"<td><h2>Local Trip Type</h2></td>";
...
$sql = "UPDATE tb_local_trip SET DriverName='$Program_Name', MobileNo='$Program_no',CarRegistrationNo='$Program_cr',LicenseNumber='$Program_licence_no',LicenseExpireDate='$Program_LicenseExpireDate',FatherName='$Program_FatherName',MotherName='$Program_MotherName',NID='$Program_NID' where CarRegistrationNo='".$Program_cr."'";
