...
<head>
 ...
 <link rel="stylesheet" type="text/css" href="css/dashboard.css">
   <script src="https://kit.fontawesome.com/3b71e37289.js"></script>
	<title>Driver Information List</title>
</head>
<body>
<div class="wrapper">
	<!-- Sidebar/menu -->
...
<a href="driver_add2.php" class="button">Add Driver Info</a>
</div>
</div>
...
if ($result->num_rows > 0) {
    ...
    <td><a href =delete_driver.php?CarRegistrationNo=".$row["CarRegistrationNo"].">Delete</a>     </td>
    <td><a href =edit_driver_info.php?CarRegistrationNo=".$row["CarRegistrationNo"].">Update</a>     </td>
    <td><a href =print_diver.php?CarRegistrationNo=".$row["CarRegistrationNo"].">Print</a> </td>
    </tr>";
     }
     echo "</table>";
} else {
