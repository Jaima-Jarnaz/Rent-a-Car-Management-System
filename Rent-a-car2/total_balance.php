...
$query_local="select sum(ContactRate) as 'sumcontactlocal' from tb_local_trip";

$res=mysqli_query($conn,$query);
$res_local=mysqli_query($conn,$query_local);

$data=mysqli_fetch_array($res);
$data_local=mysqli_fetch_array($res_local);
...
<div class="jumbotron">
  <h5 class="display-4">Total Balance for Trip and Local Trip</h5>
  <hr class="my-4">
  <div class="row ">
      <div class="col">
          <h2 class="text-success">Total Contact Rate</h2>
          <h3 class="font-weight-bold "><?php   echo "".$data['sumcontact']+$data_local['sumcontactlocal']; ?></h3>
      </div>
  </div>
